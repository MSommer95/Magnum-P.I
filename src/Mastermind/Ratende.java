...
public class Ratende extends JFrame {
	...
	private void initialisiereKomponenten() {
		...
		this.fünf = new JButton("1");
		this.sechs = new JButton("2");
		this.sieben = new JButton("3");
		this.acht = new JButton("4");
		this.neun = new JButton("1");
		this.zehn = new JButton("2");
		this.elf = new JButton("3");
		this.zwölf = new JButton("4");
		this.dreizehn = new JButton("1");
		this.vierzehn = new JButton("2");
		this.fünfzehn = new JButton("3");
		this.sechzehn = new JButton("4");
		this.siebzehn = new JButton("1");
		this.achtzehn = new JButton("2");
		this.neunzehn = new JButton("3");
		this.zwanzig = new JButton("4");
		this.einundzwanzig = new JButton("1");
		this.zweiundzwanzig = new JButton("2");
		this.dreiundzwanzig = new JButton("3");
		this.vierundzwanzig = new JButton("4");
		this.fünfundzwanzig = new JButton("1");
		this.sechsundzwanzig = new JButton("2");
		this.siebenundzwanzig = new JButton("3");
		this.achtundzwanzig = new JButton("4");
		this.neunundzwanzig = new JButton("1");
		this.dreißig = new JButton("2");
		this.einunddreißig = new JButton("3");
		this.zweiunddreißig = new JButton("4");
